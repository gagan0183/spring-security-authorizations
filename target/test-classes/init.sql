    ...
    create table users(
		...
		password varchar_ignorecase(900) not null,
...
insert into users (username, password, enabled) values ('nuser', 'e39ec4321763efff5edfc43b44c438d78a416195c7e57d64e46716cea4b78525a852578310e88335', 1);
insert into users (username, password, enabled) values ('auser', 'e39ec4321763efff5edfc43b44c438d78a416195c7e57d64e46716cea4b78525a852578310e88335', 1);
...
insert into AUTO_USER (autoUserId, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE) values (1, 'kevin.m.bowersox@gmail.com', 'Kevin', 'Bowersox', 'password', 'kbowersox', 'ROLE_USER');
insert into AUTO_USER (autoUserId, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE) values (2, 'johndoe@gmail.com', 'John', 'Doe', 'password', 'johndoe', 'ROLE_USER');
insert into AUTO_USER (autoUserId, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE) values (3, 'janedoe@gmail.com', 'Jane', 'Doe', 'password', 'janedoe', 'ROLE_USER');
insert into AUTO_USER (autoUserId, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, ROLE) values (4, 'juniordoe@gmail.com', 'Junior', 'Doe', 'password', 'jrdoe', 'ROLE_USER');
